...
angular.module("mygithub").config(function (serialGeneratorServiceProvider) {//serialGenerator
    serialGeneratorServiceProvider.setLength(20);
    console.log("SerialGeneratorProviader config: "+serialGeneratorServiceProvider.getLength());
});